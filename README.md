...
This project is a drum machine with a 16-step sequencer and 6 instruments. The sequencer interface resembles that of Roland TR-X0X style drum machines, and the sound is generated by the Yamaha OPL2 FM chip. Additionally, it has a screen for managing settings such as tempo, volume, and tuning.
